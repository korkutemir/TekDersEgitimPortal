...
namespace BuildBackEnd.Web.Controllers
{
    ...
    public class CourseController : Controller
    {
        ...
        public CourseController(ICourseService courseService, IMediaService mediaService, IUserCourseBridgeService userCourseBridgeService, IHttpContextAccessor httpContextAccessor, IResponseService responseService, IMapper mapper)
        {
