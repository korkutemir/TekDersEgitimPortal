...
namespace BuildBackEnd.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ICourseService courseService, IUserCourseBridgeService userCourseBridgeService, SignInManager<Users> signInManager, UserManager<Users> userManager, RoleManager<UserRole> roleManager, IResponseService responseService, IMemberService memberService)
        {
